...
export default function AdminLayout({ children }) {
  ...
  // Khi pathname thay đổi => bật loading ngắn
  useEffect(() => {
    setLoading(true);
    const timeout = setTimeout(() => setLoading(false), 500); // 0.5s loading
            ...
            <div className="header__profile">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <path strokeLinecap="round" strokeLinejoin="round"
                  ...
                  9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 
                  8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 
